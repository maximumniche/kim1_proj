numDisplays = int(input("Type in the number of sequential displays you want (1-16): "))
limit = str(hex(numDisplays * 8))
...
for i in range(numDisplays):
    ...
    for char in sequence:
        sequence_str += (symbols[char] + ", ")

    sequence_str = sequence_str[:len(sequence_str)-2]

    sequence_str += (" ; " + sequence)
    
    displays.append(sequence_str)

print("Your displays are:")
for display in displays:
    print(display)

file = open("C:/Users/Imad/Documents/VSCode/kim1_proj/SPI_Display/16_Word_Display_R1/displays.txt", "w")
