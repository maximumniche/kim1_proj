; display_bit_banging.asm
; program to do SPI 256 word input to MAX7219 LED chip with software bit-banging on KIM-1
; MOS6502 assembly
...
main:
    ...
    ; send all data to display in 1 second intervals,
...
spi_send: ; subroutine to send 2 bytes for display
